...
class MoonSynodicRhythmRecord
{
     ...
     */
    public function getPeriodType(): MoonPeriodType
    {
     ...
     *
     * @param MoonSynodicRhythmRecord $object
     * @return boolean
     */
    public function equals(MoonSynodicRhythmRecord $object): bool
    {
