...
class FromMoonSynodicRhythm implements Builder
{
    /**
     ...
     */
    protected \MarcoConsiglio\Ephemeris\Rhythms\MoonSynodicRhythm $data;
     ...
     *
     * @param \MarcoConsiglio\Ephemeris\Rhythms\MoonSynodicRhythm $synodic_rhythm
     * @param \MarcoConsiglio\Ephemeris\Rhythms\Enums\MoonPhaseType[] $moon_phase_types The list of MoonPhaseType used to filter the 
     ...
     */
    public function __construct(MoonSynodicRhythm $synodic_rhythm, array $moon_phase_types)
    {
        ...
        $this->records = $this->data->transform(function ($record, $key) {
            ...
            foreach ($strategies as $strategy) {
                ...
                if ($record_found = $a_strategy->found()) {
                    return new MoonPhaseRecord($record_found->timestamp, MoonPhaseType::getCorrespondingType($strategy));
                }
            }
