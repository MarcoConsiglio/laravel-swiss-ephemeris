...
class FromMoonSynodicRhythm implements Builder
{
     ...
     *
     * @param \MarcoConsiglio\Ephemeris\Rhythms\MoonSynodicRhythm $data
     */
    public function __construct(MoonSynodicRhythm $data)
    {
        $this->data = $data;
    }
    ...
    public function buildRecords()
    {
        ...
        $this->items = $periods->map(function ($period, $key) {
            ...
            return new MoonPeriod($first_record->timestamp, $last_record->timestamp, $first_record->getPeriodType());
        })->all();    
    }
